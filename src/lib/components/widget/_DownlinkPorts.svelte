<script>
    ...
    const { getDatasheet, getModel, getSimilarSeries, getDevices } = getContext('FeatureWidget');
    $: {
        console.log('Context: ', datasheet);
    }
    ...
    /** @type {[String, any][]} To iterate model related data */
    let modelsMap;
    /** @type {Object} To track rowspans*/
    ...
    <section class="slide-body">
        <div class="col col-1">
            ...
            <div class="column-group">
                <p><strong>{similarSeriesUI['portCount']}</strong></p>
                <p>{$format('feature_widget_downlinks_port_count')}</p>
            </div>
            <div class="column-group">
                <p><strong>{similarSeriesUI['portOption']}</strong></p>
                <p>{$format('feature_widget_downlinks_port_option')}</p>
            </div>
            <div class="column-group">
                <p><strong>{similarSeriesUI['portSpeed']}</strong></p>
                <p>{$format('feature_widget_downlinks_port_speed')}</p>
            </div>
        </div>
        <div class="col col-2">
            ...
            <div class="column-group">
                <p><strong>{activeModelUI['portCount']}</strong></p>
                <p>{$format('feature_widget_downlinks_port_count')}</p>
            </div>
            <div class="column-group">
                <p><strong>{activeModelUI['portOption']}</strong></p>
                <p>{$format('feature_widget_downlinks_port_option')}</p>
            </div>
            <div class="column-group">
                <p><strong>{activeModelUI['portSpeed']}</strong></p>
                <p>{$format('feature_widget_downlinks_port_speed')}</p>
            </div>
        </div>
        <div class="col col-3">
            ...
            <div class="column-group">
                <p><strong>{similarModelUI['portCount']}</strong></p>
                <p>{$format('feature_widget_downlinks_port_count')}</p>
            </div>
            <div class="column-group">
                <p><strong>{similarModelUI['portOption']}</strong></p>
                <p>{$format('feature_widget_downlinks_port_option')}</p>
            </div>
            <div class="column-group">
                <p><strong>{similarModelUI['portSpeed']}</strong></p>
                <p>{$format('feature_widget_downlinks_port_speed')}</p>
            </div>
        </div>
    </section>
