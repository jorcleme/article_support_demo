<script>
	...
	import _List from './ListMedia.svelte';
	...
	const placeholder = 'Search for Media...';
	...
	export let labelIdentifier = 'title';
	...
	function dispatchSelectedItem() {
		if (
			!prev_value ||
			JSON.stringify(value[optionIdentifier]) !== JSON.stringify(prev_value[optionIdentifier])
		) {
	...
	export function handleClear() {
		console.log('hello from handle clear')
		value = undefined;
		listOpen = false;
